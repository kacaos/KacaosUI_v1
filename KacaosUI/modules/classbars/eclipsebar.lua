...
local mover = CreateFrame("Frame", "TukuiEclpiseBarMover", UIParent)
mover:Width(tbWidth)
...
mover.Text:SetPoint("CENTER", TukuiEclpiseBarMover, "CENTER", 0, 0)
mover.Text:SetText(L.mover_cbebar)
...
eBar.tframe:FontString("text", C.media.pixelfont, 10, "MONOCHROMEOUTLINE")
